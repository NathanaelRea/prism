-- Normalize rebuildable provider caches after a complete released v1/v2 contract match.
-- Durable repository, Worktree Session, Plan, Auto Flow, notification, and integration state is
-- deliberately untouched. The obsolete subsystem-local schema marker is retired.
