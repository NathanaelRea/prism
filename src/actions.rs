...
use crate::tui::{
    ...
    OpencodePollKey, OpencodePollResult, PanelFocus, PlanRunResult, PrPollKey, PrPollResult, Tui,
    WtPollResult,
};
...
mod tests {
    ...
    use super::{
        copy_to_clipboard, discover_wt_columns, run_browser_opener, status_label_with_behind,
    };
