...
CREATE TABLE auto_run (
          ...
          created_unix_ms integer not null,
          updated_unix_ms integer not null,
          archived_unix_ms integer, change_request_identity_json text, worktree_session_id text,
...
CREATE TABLE pr_details_cache (
          ...
          refreshed_unix_ms integer not null,
          observation_error text
        , provider text, canonical_host text, project_path text, native_cr_id text, display_number integer, source_provider text, source_canonical_host text, source_project_path text, target_provider text, target_canonical_host text, target_project_path text, identity_complete integer not null default 0);
