...
- `C` opens a picker of remote pull requests for the selected repository and creates or selects a local worktree using the PR's head branch name. An existing local branch is reused without resetting it.
